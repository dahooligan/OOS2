...
public class IoCContainer {
	...
	// Methode um einen Typ unter automatischer Auflösung der Abhängigkeiten zu instanzieren
	public Object resolve(Class classWithDependencies) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		// Ersten Konstruktor der Klasse auswählen (Einschränkung)
		Constructor ctr = classWithDependencies.getConstructors()[0];
		// Liste für die Übergabe der instanzierten Abhängigkeiten an den Konstruktor der Klasse
		...
		for(Class parameter : ctr.getParameterTypes()) {
			// Parameter instanzieren (Achtung: Keine rekursive Auflösung! -> Einschränkung)
			Object arg = ...
			// Parameterobjekt in Liste aufnehmen
			...
		}
		
		// Klasse mit automatisch aufgelösten Abhängigkeiten instanzieren und zurückgeben
		return ...
	}
}
